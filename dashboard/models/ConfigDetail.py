...
class ConfigDetailManager(BaseModelManager):
...
class ConfigDetail(BaseModel):
    class Meta:
        db_table = '"dashboard_ configdetail"'
    
    name = models.CharField(max_length=255, null=True)
    head = models.ForeignKey('dashboard.ConfigHead', on_delete=models.CASCADE, null=True)
    ...
    filter_objects = ConfigDetailManager()
