...
#     if created:
#         # user=instance
#         d = {'site_url': 'http://dev.vidhyadhan.in','user':instance}
#         Email_Queue.objects.create(
#             subject = 'Vidhyadhan - Your account has been created successfully.',
...
def fee_payment_recipt(sender, instance, created, **kwargs):
    d = {'site_url': 'http://dev.vidhyadhan.in','user':instance.student.user,'fee':instance}
