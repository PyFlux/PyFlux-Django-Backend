...
class ShiftAllocationListAPIView(CURDViewSet):
    queryset = ShiftAllocation.objects.filter(status=1, deleted_at=None)
    serializer_class = ShiftAllocationSerializer
